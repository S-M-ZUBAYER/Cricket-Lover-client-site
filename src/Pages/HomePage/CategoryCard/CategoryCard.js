...
const CategoryCard = (category) => {
    ...
    console.log(categoryName, categoryImage, products, categoryId)
    ...
    return (
        <div>
            <div class="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
                <div class="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md" style={{ backgroundImage: `url(${category.category.categoryImg})` }}></div>

                <div class="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
                    <h3 class="py-2 font-bold tracking-wide text-center text-gray-800 uppercase dark:text-white">{category.category.categoryName}</h3>
