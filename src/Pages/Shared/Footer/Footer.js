...
const Footer = () => {
    return (
        <footer className="bg-white dark:bg-gray-900 bg-gradient-to-l from-blue-900 via-slate-900 to-black pt-12">
            <div className="container p-6 mx-auto">
                ...
                <div>
                    <p className="text-center text-gray-200 dark:text-gray-400">© Cricket Lover 2022 - All rights reserved</p>
                </div>
            </div>
        </footer>
    );
