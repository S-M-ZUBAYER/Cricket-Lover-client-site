...
const Contact = () => {
    ...
    return (
        <section className="min-h-screen text-gray-200 bg-gradient-to-l from-blue-900 via-slate-900 to-black pb-20">
                ...
                <div className="lg:flex lg:items-center lg:-mx-10">
                    <div data-aos="fade-right" data-aos-duration="2000" className="lg:w-1/2 lg:mx-10">
                        ...
                        <form className="mt-12 ">
                            ...
                            <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide  capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                get in touch
                            </button>
                        </form>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000" className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10 v">
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            <p className="flex items-start -mx-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 truncate w-72 ">+880 1304979278</span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 truncate w-72 dark:">smzubayer9004@gamil.com</span>
                            </p>
                        </div>
                        ...
                        <div className="mt-6 w-80 md:mt-8">
                            ...
                            <div className="flex justify-center mt-4 -mx-1.5 ">
                                <Link className="mx-1.5 dark:hover:text-blue-400  transition-colors duration-300 transform hover:text-blue-500" to=''>
            ...
            <iframe data-aos="fade-up" width="80%" height="500px" className="mx-auto rounded-2xl" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20Kushtia+()&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
